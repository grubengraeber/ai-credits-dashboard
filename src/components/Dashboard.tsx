      ...
      <header className="border-b border-zinc-800 bg-zinc-900/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold">AI Credits Dashboard</h1>
          </div>
          <div className="flex items-center gap-3">
            <select
              value={autoRefresh}
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg text-sm transition"
            >
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        {loading ? (
          ...
          <div className="text-center py-20">
            <Zap className="w-12 h-12 mx-auto mb-4 text-zinc-600" />
            <h2 className="text-xl font-semibold mb-2">No providers configured</h2>
            <p className="text-zinc-400 mb-6">Add your first AI provider to start tracking credits</p>
            <button
              onClick={() => setShowAdd(true)}
